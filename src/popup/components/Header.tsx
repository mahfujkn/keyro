...
export const Header: React.FC<HeaderProps> = ({ onSettingsClick, onAboutClick }) => {
  return (
    <header className="k-header">
      <div className="k-header__logo-area">
        ...
        <div>
          <div className="k-header__title">Keyro</div>
          <div className="k-header__subtitle">Secure Password Generator</div>
        </div>
      </div>
      <div className="k-header__actions">
        <button className="k-icon-button" onClick={onSettingsClick} aria-label="Settings" title="Settings">
        ...
        <button className="k-icon-button" onClick={onAboutClick} aria-label="About" title="About">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
